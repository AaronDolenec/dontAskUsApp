                ...
                Positioned.fill(
                  child: Align(
                    ...
                    child: AnimatedContainer(
                      ...
                      width: MediaQuery.of(context).size.width * (_percentage / 100) * 0.8,
                      decoration: BoxDecoration(
                        color: optionColor.withValues(alpha: isWinner ? 0.2 : 0.1),
                      ),
                    ),
                  ),
                ),
                    ...
                    // Vote count and percentage
                      ...
                      Text(
                        ...
                        style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                          ...
                          color: isWinner ? optionColor : AppColors.textSecondary,
                        ),
                      ),
